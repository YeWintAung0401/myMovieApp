      ...
      <div className="w-full max-w-md bg-[#16151a] p-10 rounded-2xl shadow-2xl border border-gray-800">
        ...
        <form className="space-y-5">
          ...
          <label className="flex items-center space-x-2 text-gray-400 text-sm cursor-pointer">
            ...
            <span>I agree to the <span className="text-[#ff55a5]">Privacy Policy</span></span>
          </label>
        ...
        <p className="text-gray-400 text-center mt-8 text-sm">
          Already have an account? <Link href="/user/signin" className="text-[#ff55a5] hover:underline">Sign in!</Link>
        </p>
      </div>
    </div>
  );
