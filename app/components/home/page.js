...
// 1. Define your array of banners
const BANNERS = [
  {
    id: 1,
    title: "Savage Beauty",
...
const HomePage = () => {
  ...
  return (
    /* Main Wrapper: Centers the entire section and provides spacing */
    <div className="flex flex-col items-center justify-center py-6 px-4 md:px-8 lg:px-12 min-h-[calc(100vh-200px)] bg-[#1a191f]">
      ...
      <section className="relative w-full max-w-7xl h-[450px] sm:h-[500px] md:h-[600px] overflow-hidden rounded-3xl group shadow-2xl">
